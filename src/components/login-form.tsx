    ...
    <form action={action} className="space-y-5">
      ...
      <label className="block text-sm font-semibold text-slate-700">
        ...
        <span className="mt-2 flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-3.5 focus-within:border-cyan-500">
          ...
          <input name="email" type="email" autoComplete="email" defaultValue="admin@senddesk.demo" className="h-12 min-w-0 flex-1 border-0 bg-transparent outline-none" required />
        </span>
      ...
      <label className="block text-sm font-semibold text-slate-700">
        ...
        <span className="mt-2 flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-3.5 focus-within:border-cyan-500">
          ...
          <input name="password" type="password" autoComplete="current-password" defaultValue="Demo1234!" className="h-12 min-w-0 flex-1 border-0 bg-transparent outline-none" required />
        </span>
